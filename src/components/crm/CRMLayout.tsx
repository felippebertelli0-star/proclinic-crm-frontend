...
export function CRMLayout() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#0d1f2d', color: '#e8edf2', fontFamily: "'Segoe UI', -apple-system, BlinkMacSystemFont, 'Helvetica Neue', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ fontSize: '12px', color: '#7a96aa', fontStyle: 'italic', display: 'flex', alignItems: 'center', gap: '4px', height: '18px', lineHeight: 1 }}>
      ...
      {/* SIDEBAR */}
      <div style={{ width: sidebarCollapsed ? '70px' : '650px', background: '#0a1520', borderRight: '1px solid #1e3d54', display: 'flex', flexDirection: 'column', transition: 'width 0.3s', overflow: 'hidden' }}>
        {/* LOGO */}
